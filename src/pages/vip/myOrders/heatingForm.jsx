        ...
        <div className="grid grid-cols-2 gap-4 mt-2 w-full">
          <Form.Item
            ...
            className={`m-0 p-1 border-[1px] ${
              foodValue ? "border-[#3E7D91]" : "border-gray-300"
          ...
          >
            ...
            <div className="w-[100%] flex flex-col text-[#3E7D91] items-center justify-center pt-5 pb-10">
              <svg
                width="25"
                height="24"
                viewBox="0 0 25 24"
          ...
          <Form.Item
            ...
            className={`m-0 p-1 border-[1px] ${
              beverageValue ? "border-[#3E7D91]" : "border-gray-300"
            } rounded-xl border-solid cursor-pointer `}
            name="beverage"
          >
            <Checkbox
        ...
        <div className="border-[.3px] border-solid flex items-center justify-between border-gray-300 rounded-xl p-2 my-1">
          ...
          <div className="btn">
            <Button
              ...
              className="border-none  bg-[#f5f6fa]  text-[#3E7D91]"
            >
