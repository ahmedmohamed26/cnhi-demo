          ...
          isOpen == "building" ? (
            <div className="grid grid-cols-2 gap-4">
              ...
              <Button
                ...
                className="w-full rounded-xl border-none hover:bg-[#ced0da] bg-[#ced0da] text-[#3E7D91]"
              >
                {t("cancel")}
              </Button>
            </div>
